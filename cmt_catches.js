...
…    
    ...
    addLinkToUI();t user catch data from server
    async function getCatchStats(){
        let cookiematerial = {};
        let data;
        const xhr = new XMLHttpRequest();
    ...
    async function uponButtonClick(){
        ...
        const topDiv = createGenericTopDiv(mainDiv, "Area Crown Progress");
        ...
        micenames.forEach(el=>{
            ...
            image.title = el;
            image.src = mouseList[el]['thumb'];
            imageSpan.appendChild(image);
            imageField.appendChild(imageSpan);
            console.log(image);
            console.log(mouseList[el]['thumb'])
            ...
            mouseRow.appendChild(imageField);
